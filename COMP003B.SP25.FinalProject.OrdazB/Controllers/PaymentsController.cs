...
namespace COMP003B.SP25.FinalProject.OrdazB.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(WebDevAcademyContext context)
        {
            _context = context;
        }
        ...
        {
            var webDevAcademyContext = _context.Payments.Include(p => p.Booking).Include(p => p.User);
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,UserId,BookingId,DateOfPayment,PaymentAmount")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,UserId,BookingId,DateOfPayment,PaymentAmount")] Payment payment)
        {
